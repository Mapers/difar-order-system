            ...
            <CardContent className="space-y-6 pt-6 px-3 sm:px-6">
                ...
                Buscar por RUC, DNI o nombre...
                        ...
                        <SearchPickerDialog<IClient>
                            ...
                            emptySubMessage="Intente con otro RUC, DNI o nombre"
                ...
                {selectedClient && isAdmin && (
                  ...
                  Buscar vendedor...
                        ...
                        <SearchPickerDialog<Seller>
                            ...
                            heightClassName="sm:h-[65vh]"
                            renderItem={(s) => (
                                <div className="flex items-center gap-3 px-4 py-3 hover:bg-indigo-50 dark:hover:bg-indigo-950/20">

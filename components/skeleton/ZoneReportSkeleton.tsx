...
export const ClientCardSkeleton = () => (
  ...
  <Tabs defaultValue="resumen" className="w-[73vw] max-w-4xl max-h-[80vh] overflow-y-auto mx-2">
    <TabsContent value="resumen" className="space-y-6 mt-6">
      <div className="space-y-6">
        <Card className="bg-gray-100 border-gray-300 p-3 h-15">
          <CardContent className="p-3 h-15">

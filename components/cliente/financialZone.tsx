...
interface ClientRowProps {
  client: IClient;
  nameZone: string;
  unidadTerritorio :ITerritorio | null
}
        ...
        <DialogTrigger asChild>
          <div className="flex items-center gap-3 p-4 bg-purple-50 rounded-lg border border-purple-200 cursor-pointer hover:bg-purple-100 transition-colors">
            ...
            <div className="flex-1">
              ...
              <p className="text-lg font-semibold text-gray-900">Zona {nameZone || "------"} </p>
              ...
              <div className="space-y-3">
                <div className="flex items-center gap-2 p-3 bg-purple-50 rounded-lg">
                  ...
                  <div>
                    ...
                    <p className="text-sm font-semibold text-gray-900">{nameZone}</p>
                  </div>
                </div>

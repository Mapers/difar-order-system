...
// Versión Alpha: igual que PaymentCondition, sin el bloque "Resumen de
// Condiciones" — repetía como badges lo que ya se ve en los dos selectores
// de arriba, sin agregar información nueva.
const PaymentConditionAlpha: React.FC<ClientRowProps> = ({
                                                      conditions,
                                                      monedas,
                                                      onConditionChange,
                                                      onCurrencyChange,
  ...
  return (
      <Card className="bg-background shadow-sm border-l-4 border-l-emerald-400 transition-shadow hover:shadow-md">
        <CardHeader>
...
export default PaymentConditionAlpha;

...
// Versión Alpha de ContactInfo: "Información de Contacto" e "Información
// de Entrega" quedan cada una en su propia tarjeta (mismo lugar de
// siempre, dentro del widget Cliente), en vez de compartir una sola grilla
// de 2 columnas sin borde propio.
const ContactInfoAlpha: React.FC<ClientRowProps> = ({
                                                 client,
                                                 referenciaDireccion,
                                                 contactoPedido,
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <Card className="bg-background shadow-sm border-l-4 border-l-blue-400 transition-shadow hover:shadow-md">
        <CardHeader>
        ...
        <CardContent className="space-y-3">
          <div className="p-3 bg-blue-50 rounded-lg">
            ...
            {isEditingPhone ? (
                ...
                <p className="text-sm text-blue-900">{client.telefono ?? '+51 ---------'}</p>
            )}
          </div>
      ...
      <Card className="bg-background shadow-sm border-l-4 border-l-green-400 transition-shadow hover:shadow-md">
        <CardHeader>
...
export default ContactInfoAlpha;

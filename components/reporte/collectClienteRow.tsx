                    ...
                    <div className="flex flex-col md:flex-row md:justify-between md:items-center">
                        <div className="flex-1">
                            ...
                            <div className="text-sm text-gray-600">
                                <span className="font-medium">Cliente:</span> {client.head.Nombre}
                            </div>
                        </div>
                    ...
                    <Table>
                        ...
                        <TableBody>
                            {invoices.map((invoice: Invoice, index) => (
                                <InvoiceCollectClientRow key={invoice.Fecha_Emision + index} invoice={invoice} />
                            ))}
                        </TableBody>
                    </Table>
                </div>
...
export default CollectClienteRow;
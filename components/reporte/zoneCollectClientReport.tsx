...
const ZoneCollectClientReport: React.FC<ZoneSellerReportProps> = ({ zone, clients }) => {
  return (
    <div className="mb-8">
      ...
      <div className="mt-4">
        {clients.length > 0 ? (
          clients.map((client: Client) => (
            <CollectClienteRow key={client.head.Nombre} client={client} invoices={client.boddy} />
          ))
        ) : (
...
export default ZoneCollectClientReport;

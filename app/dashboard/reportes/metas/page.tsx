...
export default function MetasDashboardPage() {
    ...
    const handleVendedorClick = (v: IVendedorDashboard) => {
    ...
    return (
        <div className="grid gap-4">
            ...
            {loadingDashboard ? (
                ...
                <VendedorDashboardView data={dashboardData} kpis={kpis} />
            ) : (
                <>
                    {/* Tabs admin */}
                    ...
                    {activeTab === "laboratorios" && (
                        <LaboratoriosTab laboratorios={dashboardData.laboratorios} />
                    )}

...
export function RelatedComprobanteModal({
    ...
    const tipoLabel = (tipo?: number | null) => {
        ...
        return             { label: 'Comprobante', color: 'bg-muted text-muted-foreground'  }
    }
                ...
                <div className="py-4">
                    {(guia?.idComprobanteCab && guia.comprobante_serie != null) ? (
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between border p-3 rounded-lg bg-background hover:bg-muted transition-colors">
                                <div className="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div className="flex items-center gap-3 mt-0.5">
                                            <p className="text-xs text-muted-foreground">Pedido: #{guia.nroPedido}</p>
                                            <p className="text-xs text-muted-foreground truncate max-w-[160px]">{guia.cliente_denominacion}</p>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div className="text-center py-8 text-muted-foreground border-2 border-dashed rounded-lg bg-muted">
                            ...
                            <p className="text-xs text-muted-foreground mt-1">Esta guía no tiene un comprobante vinculado aún</p>
                        </div>
                    )}
                </div>
